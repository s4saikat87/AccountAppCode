...
import { getAuth,signInWithRedirect,signInWithPopup,GoogleAuthProvider,OAuthProvider,FacebookAuthProvider } 
from 'firebase/auth';
import { 
    getFirestore,
    doc,
...
const firebaseConfig = { 
  ...
  export const signInWithFacebookPopup=()=>signInWithPopup(auth,providerFb);
